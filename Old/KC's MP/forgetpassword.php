 	...
 	<div class="banner-main">
		<div class="signin-form">
			<div class="signin">
				...
				<?php getToken(); ?>
					<form action="forgetpasswordcheck.php" method="post" id="forgetpassword-form"
						autocomplete="off">
						<h2 align="center">Forget Password</h2>

						<div id="form-content">
							<fieldset>
								<p align="center">You have to enter either your Username or Email</p>
								<div class="fieldgroup">
									<label for="username">Username: </label> <input name="username"
										type="text" id="username" maxlength="15" >

								</div>
								
								<div class="fieldgroup">
									<p class="hypen" align="right">OR</p>
